...
public class Legends implements Game{
...
//        and their skill levels
        ...
        for (int i = 0; i < size; i++) {
            ...
            for (int j = 0; j < size; j++) {
                if (heroPos[0] == i && heroPos[1] == j){
                    ...
                    s.append("|").append(grid.getCell(i, j).toString());
                }
            }
            s.append("|\n");
        }
    ...
    private boolean askRevive() throws InterruptedException {
        ...
        System.out.println("(Notice: Heroes' level)");
        Scanner scanner = new Scanner(System.in);
