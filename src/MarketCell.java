...
//        Name/cost/required level/attribute increase/attribute affected
        ...
        for (int i = 0; i < potion.length; i++) {
            String[] target = potion[i];
            System.out.printf(s.toString(),(start+i), target[0], target[2],
    ...
    private void showSpell(int start){
        ...
        StringBuilder s = new StringBuilder();
        StringBuilder sLine = new StringBuilder();
        int[] tableSize = new int[]{3, 20, 5,3,6, 6};  // Name/cost/required level/damage/mana cost
        s.append("|%") ;
        sLine.append("+");
        for (int j : tableSize) {
            s.append(j).append("s|%");
        ...
        System.out.println(sLine.toString());
//        Name/cost/required level/attribute increase/attribute affected
        System.out.printf(s.toString(),"ID","Item Name", "Cost","Lv","damage","mana");
        System.out.println(sLine);
        for (int i = 0; i < spell.length; i++) {
            String[] target = spell[i];
            System.out.printf(s.toString(),(start+i), target[0], target[2],
                    target[3], target[4],target[5]);
        }
        System.out.println(sLine.toString());
...
//        Name/cost/required level/attribute increase/attribute affected
    ...
    public String toString() {
        return MyFont.ANSI_YELLOW + "$$$" + MyFont.ANSI_RESET;
    }
}
