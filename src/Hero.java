...
public class Hero extends Character {
    ...
    Hero(String[] heroData, String type){
        ...
        strength = new Skill("strength", Integer.parseInt(heroData[2]), Boolean.getBoolean(heroData[7]));
        agility = new Skill("agility", Integer.parseInt(heroData[3]), Boolean.getBoolean(heroData[8]));
        dexterity = new Skill("dexterity", Integer.parseInt(heroData[4]), Boolean.getBoolean(heroData[9]));
