...
// HeroCreator class. It's a singleton. One game only have one HeroCreator. If the hero was chosen, he can't be chosen anymore.
public class HeroCreator {
    ...
    public Hero createHero(String occupation, int id){
        ...
        assert target != null;
        return new Hero(target[id], occupation);
    }
